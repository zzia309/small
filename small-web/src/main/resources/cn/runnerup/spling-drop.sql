...
CREATE TABLE `sp_customers` (
  ...
  `cs_carPrice` double(10, 4) DEFAULT NULL,
  `cs_carLoans` double(10, 4) DEFAULT NULL,
  `cs_carRate` double(10, 4) DEFAULT NULL,
  `cs_carBrokerage` double(10, 4) DEFAULT NULL,
  `cs_carToObject` varchar(64) DEFAULT NULL,
  `cs_carToAccount` varchar(64) DEFAULT NULL,
  `cs_bail` double(10, 4) DEFAULT NULL,
  `cs_notaryFees` double(10, 4) DEFAULT NULL,
  `cs_otherFees` double(10, 4) DEFAULT NULL,
  `cs_guaranteeFees` double(10, 4) DEFAULT NULL,
...
CREATE TABLE `sp_businesses` (
  ...
  `buss_advances` double(10, 4) DEFAULT NULL,
